  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 px-5 py-6">
      <header className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-ink">{catEmoji} {catLabel}</h1>
      </header>
      ...
      <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-amber-400 via-orange-400 to-rose-400 p-5 text-white shadow-lg">
        <p className="text-[10px] font-bold uppercase tracking-wider text-white/85">{catEmoji} {catLabel}</p>
