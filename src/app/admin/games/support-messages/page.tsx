...
export const metadata = { title: "Pesan Otomatis (Support) — Admin Flouwell" };
...
export default async function AdminEditorPage() {
  ...
  return (
    <AdminPageShell pageKey="support-messages" title="💙 Pesan Otomatis (Support)" subtitle="Template pesan ke user dalam kondisi crisis/severe screening/mood streak.">
