    ...
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 px-5 py-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-ink/45">
          <span>oleh {ep.profiles?.handle ?? "Anonim"}</span>{"  "}<span>{fmt(ep.created_at)}</span>{"  "}<span className="inline-flex items-center gap-1"><svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg> {ep.views} dibaca</span>
        </p>
      </div>
